...
      kvBackground.classList.add("kv-background");
	...
	if (item.dolg>item.nach*6 && item.nach>50)   kvBackground.classList.add("red");
...
        if (item.dolg && item.nach && parseFloat(item.dolg) > parseFloat(item.nach) * 6 && parseFloat(item.nach)>50) {
